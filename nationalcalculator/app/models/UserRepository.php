...
class UserRepository
{
    ...
    public function login($input)
    {
        ...
        return AuthHelper::logAttempt($input, Config::get('confide::signup_confirm'), $identityColumns);
    }
    ...
    {
        return AuthHelper::isThrottled($input);
    }
    ...
    {
        $result = false;
        $user   = AuthHelper::userByResetPasswordToken($input['token']);
        ...
        if ($result)
            AuthHelper::destroyForgotPasswordToken($input['token']);
