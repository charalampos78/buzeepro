 ...
 * Generated for Laravel 4.2.17 on 2016-01-25.
 *
...
namespace {
    ...
    class Entrust extends \Zizaco\Entrust\EntrustFacade{
         ...
         * Get the currently authenticated user or null.
         *
         * @return \Zizaco\Entrust\Models\User|null 
         * @static 
         */
        public static function user(){
    ...
    class HMVC extends \Teepluss\Hmvc\Facades\HMVC{
        
        /**
         * Remote client for http request.
         *
         * @return \Teepluss\Hmvc\Client 
         * @static 
         */
        public static function getRemoteClient(){
            return \Teepluss\Hmvc\Hmvc::getRemoteClient();
        }
        ...
        public static function invoke($uri, $method, $parameters = array()){
            return \Teepluss\Hmvc\Hmvc::invoke($uri, $method, $parameters);
        }
        
        /**
         * Configure remote client for http request.
         *
         * @param array $configurations array
         * (
         ...
         * @static 
         */
        public static function configureRemoteClient($configurations){
            return \Teepluss\Hmvc\Hmvc::configureRemoteClient($configurations);
        }
         ...
         * @static 
         */
        public static function invokeRemote($uri, $method = 'GET', $parameters = array()){
            return \Teepluss\Hmvc\Hmvc::invokeRemote($uri, $method, $parameters);
        }
        
    }


    class AuthHelper extends \My\AuthHelper\Facade\AuthHelper{
         ...
         * @static 
         */
        public static function loginStateless($token){
            return \My\AuthHelper\AuthHelper::loginStateless($token);
        }
         ...
         */
        public static function logAttempt($input, $mustBeConfirmed = true){
            return \My\AuthHelper\AuthHelper::logAttempt($input, $mustBeConfirmed);
        }
         ...
         * @static 
         */
        public static function createDevice($device_data = array()){
            return \My\AuthHelper\AuthHelper::createDevice($device_data);
        }
        
    }


    class Flash extends \My\Flash\Facade\Flash{
        ...
        public static function get_messages(){
            return \My\Flash\Flash::get_messages();
        }
        ...
        public static function set_message($type, $message){
            return \My\Flash\Flash::set_message($type, $message);
        }
        ...
        public static function set_initial(){
            return \My\Flash\Flash::set_initial();
        }
         ...
         * @static 
         */
        public static function get_flash($type = null, $clear = true){
            return \My\Flash\Flash::get_flash($type, $clear);
        }
         ...
         * @static 
         */
        public static function get_flash_html($type = null, $clear = true){
            return \My\Flash\Flash::get_flash_html($type, $clear);
        }
        
    }


    class MForm extends \My\MForm\Facade\MForm{
         ...
         * @static 
         */
        public static function getPrettyName($name, $model = null){
            return \My\MForm\MForm::getPrettyName($name, $model);
        }
         ...
         * @static 
         */
        public static function toggleBootstrap($enabled = null){
            return \My\MForm\MForm::toggleBootstrap($enabled);
        }
         ...
         */
        public static function open($options = array()){
            return \My\MForm\MForm::open($options);
        }
         ...
         */
        public static function model($model, $options = array()){
            return \My\MForm\MForm::model($model, $options);
        }
         ...
         * @static 
         */
        public static function object_get($object, $key, $default = null, $return_object = false){
            return \My\MForm\MForm::object_get($object, $key, $default, $return_object);
        }
         ...
         * @static 
         */
        public static function object_get_object($object, $key, $default = null){
            return \My\MForm\MForm::object_get_object($object, $key, $default);
        }
         ...
         */
        public static function label($name, $value = null, $options = array()){
            return \My\MForm\MForm::label($name, $value, $options);
        }
         ...
         */
        public static function input($type, $name, $value = null, $options = array()){
            return \My\MForm\MForm::input($type, $name, $value, $options);
        }
         ...
         */
        public static function textarea($name, $value = null, $options = array()){
            return \My\MForm\MForm::textarea($name, $value, $options);
        }
         ...
         */
        public static function select($name, $list = array(), $selected = null, $options = array()){
            return \My\MForm\MForm::select($name, $list, $selected, $options);
        }
         ...
         * @static 
         */
        public static function select2($name, $selected = array(), $options = array()){
            return \My\MForm\MForm::select2($name, $selected, $options);
        }
         ...
         */
        public static function selectRange($name, $begin, $end, $selected = null, $options = array()){
            return \My\MForm\MForm::selectRange($name, $begin, $end, $selected, $options);
        }
         ...
         */
        public static function selectYear(){
            return \My\MForm\MForm::selectYear();
        }
         ...
         */
        public static function selectMonth($name, $selected = null, $options = array(), $format = '%B'){
            return \My\MForm\MForm::selectMonth($name, $selected, $options, $format);
        }
         ...
         */
        public static function checkbox($name, $value = 1, $checked = null, $options = array()){
            return \My\MForm\MForm::checkbox($name, $value, $checked, $options);
        }
         ...
         */
        public static function radio($name, $value = null, $checked = null, $options = array()){
            return \My\MForm\MForm::radio($name, $value, $checked, $options);
        }
         ...
         * @static 
         */
        public static function radioGroup($name, $value = array(), $checked = array(), $options = array()){
            return \My\MForm\MForm::radioGroup($name, $value, $checked, $options);
        }
         ...
         */
        public static function reset($value, $attributes = array()){
            return \My\MForm\MForm::reset($value, $attributes);
        }
         ...
         */
        public static function image($url, $name = null, $attributes = array()){
            return \My\MForm\MForm::image($url, $name, $attributes);
        }
         ...
         */
        public static function submit($value = null, $options = array()){
            return \My\MForm\MForm::submit($value, $options);
        }
         ...
         */
        public static function button($value = null, $options = array()){
            return \My\MForm\MForm::button($value, $options);
        }
        ...
        public static function text($name, $value = null, $options = array()){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::text($name, $value, $options);
        }
        ...
        public static function password($name, $options = array()){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::password($name, $options);
        }
        ...
        public static function hidden($name, $value = null, $options = array()){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::hidden($name, $value, $options);
        }
        ...
        public static function email($name, $value = null, $options = array()){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::email($name, $value, $options);
        }
        ...
        public static function url($name, $value = null, $options = array()){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::url($name, $value, $options);
        }
        ...
        public static function file($name, $options = array()){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::file($name, $options);
        }
        ...
        public static function number($name, $value = null, $options = array()){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::number($name, $value, $options);
        }
        ...
        public static function getSelectOption($display, $value, $selected){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::getSelectOption($display, $value, $selected);
        }
        ...
        public static function getIdAttribute($name, $attributes){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::getIdAttribute($name, $attributes);
        }
        ...
        public static function getValueAttribute($name, $value = null){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::getValueAttribute($name, $value);
        }
        ...
        public static function old($name){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::old($name);
        }
        ...
        public static function oldInputIsEmpty(){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::oldInputIsEmpty();
        }
        ...
        public static function getSessionStore(){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::getSessionStore();
        }
        ...
        public static function setSessionStore($session){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::setSessionStore($session);
        }
        ...
        public static function macro($name, $macro){
            //Method inherited from \Illuminate\Html\FormBuilder            
            \My\MForm\MForm::macro($name, $macro);
        }
        ...
        public static function hasMacro($name){
            //Method inherited from \Illuminate\Html\FormBuilder            
            return \My\MForm\MForm::hasMacro($name);
        }
