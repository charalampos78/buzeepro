...
(function() {
    ...
    d.formatDuration = function(a, b, c, e, g, f) {
        ...
        if (a >= h[b].contains) {
            var l = a - Math.floor(a / h[b].contains) * h[b].contains; "ss" == b ? (l = d.formatNumber(l, f), 1 == l.split(k)[0].length && (l = "0" + l)) : l = d.roundTo(l, f.precision);
            ("mm" == b || "hh" == b) && 10 > l && (l = "0" + l);
            c = l + "" + e[b] + "" + c;
            a = Math.floor(a / h[b].contains);
            b = h[b].nextInterval;
            return d.formatDuration(a, b, c, e, g, f) } "ss" == b && (a = d.formatNumber(a, f), 1 == a.split(k)[0].length && (a = "0" + a));
        ("mm" == b || "hh" == b) && 10 > a && (a = "0" + a);
        c = a + "" + e[b] + "" + c;
        if (h[g].count > h[b].count)
            for (a = h[b].count; a < h[g].count; a++) b = h[b].nextInterval, "ss" == b || "mm" == b || "hh" == b ? c = "00" + e[b] + "" + c : "DD" == b && (c = "0" + e[b] + "" + c); ":" == c.charAt(c.length - 1) && (c = c.substring(0, c.length - 1));
        return c };
    ...
    d.addPrefix = function(a, b, c, e, g) {
        ...
        if (1 < a)
            for (k = b.length - 1; - 1 < k; k--) {
                if (a >= b[k].number && (l = a / b[k].number, m = Number(e.precision), 1 > m && (m = 1), c = d.roundTo(l, m), m = d.formatNumber(c, { precision: -1, decimalSeparator: e.decimalSeparator, thousandsSeparator: e.thousandsSeparator }), !g || l == c)) { f = h + "" + m + "" + b[k].prefix;
                    break } } else
...
(function() {
    ...
    d.AmDraw = d.Class({ construct: function(a, b, c, e) { d.SVG_NS = "http://www.w3.org/2000/svg";
            ...
            return g }, ellipse: function(a, b, c, e, g) {
            var f = new d.AmDObject("ellipse", this);
            f.attr({ rx: c, ry: e, cx: a, cy: b });
            this.addToContainer(f.node, g);
            return f }, setSize: function(a, b) { 0 < a && 0 < b && (this.container.style.width = a + "px", this.container.style.height = b + "px") }, rect: function(a, b, c, e, g, f, h) {
            ...
            try {
                ...
                e && (b.left = e + "px");
                d && (b.top = d + "px") } catch (f) {} }, update: function() { this.R.update() }, addDefs: function(a) {
            if (d.hasSVG) {
...
(function() {
    ...
    d.AmDObject = d.Class({ construct: function(a, b) { this.D = b;
            ...
            return this }, clipRect: function(a, b, c, e) { this.R.clipRect(this, a, b, c, e) }, translate: function(a, b, c, e) { e || (a = Math.round(a), b = Math.round(b));
            ...
            for (var e in a)
                if (a.hasOwnProperty(e)) {
                    var g = e,
                        f = a[e];
                    c = d.getEffect(c);
                    this.R.animate(this, g, f, b, c) } }, push: function(a) {
            if (a) {
                var b = this.node;
...
(function() {
    ...
    d.SVGRenderer = d.Class({
        ...
        animate: function(a, b, c, e, g) { a.animationFinished = !1;
            var f = a.node;
        ...
        move: function(a, b, c, e) { isNaN(b) && (b = 0);
            isNaN(c) && (c = 0);
            b = "translate(" + b + "," + c + ")";
            e && (b = b + " scale(" + e + ")");
        ...
        updateWidth: function() {
            ...
            if (c) {
                ...
                if ("right" == c || "left" == c) { a -= d;
                    if (0 > a || isNaN(a)) a = 0;
                    h.width = a + "px";
                    this.balloon.setBounds(2, 2, a - 2, this.realHeight); "left" == c ? (h.left = d + "px", e.left = "0px") : (h.left = "0px", e.left = a + "px");
                    b > f && (e.top = (b - f) / 2 + "px") } }
            return a },
...
(function() {
    var d = window.AmCharts;
    d.circle = function(a, b, c, e, g, f, h, k, l) { 0 >= b && (b = .001);
    ...
    d.polygon = function(a, b, c, e, g, f, h, k, l, m, n) { isNaN(f) && (f = .01);
        isNaN(k) && (k = g);
        var q = e,
            t = !1; "object" == typeof q && 1 < q.length && (t = !0, q = q[0]);
        void 0 === h && (h = q);
    ...
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, q, t, r) {
        ...
        if (n) { k = [];
            for (u = 0; u < n.length; u++) k.push(d.adjustLuminosity(m.fill, n[u])); "radial" != r || d.isModern || (k = []);
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            var x = this.entries,
                z, v;
            for (v = 0; v < x.length; v++) { z = x[v].getBBox();
                var B = z.width;
                B > t && (t = B);
                z = z.height;
                z > r && (r = z) }
            ...
            for (v = 0; v < x.length; v++) {
                ...
                F.translate(E, w);
                B++;!isNaN(l) && B >= l && (B = 0, r++, w = w + y + m, C = f, y = 0);
                A.push(F) }
            z = A.getBBox();
            l = z.height + 2 * m - 1; "left" == a || "right" == a ? (n = z.width + 2 * f, k = n + b + c, h.style.width = k + "px", this.ieW = k) : n = k - b - c - 1;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) { c = a.type;
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) h = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), h.push(n), a.bullet && (a.hidden || (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), h.push(n)), t = 0, n = m, q = m / 3;
                        ...
                        n = m }
                    d.setCN(b, h, "graph-" + c);
                    d.setCN(b, h, "graph-" + a.id) } else if (k) h = l.image(k, 0, 0, m, m);
                else {
                    var p;
        ...
        createValue: function(a) {
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                b.equalWidths || (b.valueAlign = "left"); "left" == b.valueAlign && (g = a.legendEntry.getBBox().width);
                var f = g;
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    var k = b.valueText,
                        ...
                        l = "end"; "left" == b.valueAlign && (g -= b.valueWidth, l = "start");
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) f.value ? g.text(f.value) : g.text("");
                        ...
                        if (void 0 !== f.type) { k = f.currentDataItem;
                            ...
                            k ? (h = this.valueText, f.legendValueText && (h = f.legendValueText), h = b.formatString(h, k)) : l && b.formatPeriodString && (l = d.massReplace(l, { "[[title]]": f.title }), h = b.formatPeriodString(l, f)) } else h = b.formatString(this.valueText, f);
...
(function() {
    ...
    d.AmMap = d.Class({
        inherits: d.AmChart,
        construct: function(a) { this.cname = "AmMap";
            this.type = "map";
            this.theme = a;
            ...
            this.areasClasses = {};
            d.applyTheme(this, a, this.cname) },
        initChart: function() { this.zoomInstantly = !0;
            var a = this.container;
            this.panRequired = !0;
            if (this.sizeChanged && d.hasSVG && this.chartCreated) { this.freeLabelsSet && this.freeLabelsSet.remove();
                ...
                this.zoomControl.update && this.zoomControl.update() } else(d.AmMap.base.initChart.call(this), d.hasSVG) ? (this.dataChanged && (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, a = this.legend) && (a.position = "absolute", a.invalidateSize()), this.createDescriptionsDiv(), this.svgAreas = [], this.svgAreasById = {}, this.drawChart()) : (this.chartDiv.style.textAlign = "", this.chartDiv.setAttribute("class", "ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported, this.fire({ type: "failed", chart: this })) },
        storeTemp: function() {
        ...
        invalidateSize: function() { this.storeTemp();
            d.AmMap.base.invalidateSize.call(this) },
        validateSize: function() { this.storeTemp();
            d.AmMap.base.validateSize.call(this) },
        handleWheelReal: function(a) {
            if (!this.wheelBusy) { this.stopAnimation();
                ...
                this.zoomTo(a, e, b) } },
        addLegend: function(a, b) { a.position = "absolute";
            a.autoMargins = !1;
            a.valueWidth = 0;
            a.switchable = !1;
        ...
        drawChart: function() { d.AmMap.base.drawChart.call(this);
        ...
        buildEverything: function() {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.dispDUpd();
                this.updateSmallMap();
                this.linkSet.toFront() } else this.cleanChart() },
        hideGroup: function(a) { this.showHideGroup(a, !1) },
        showGroup: function(a) { this.showHideGroup(a, !0) },
        showHideGroup: function(a, b) { this.showHideReal(this.imagesProcessor.allObjects, a, b);
        ...
        update: function() { d.hasSVG && (d.AmMap.base.update.call(this), this.zoomControl && this.zoomControl.update && this.zoomControl.update()) },
        animateMap: function() {
            var a = this;
        ...
        handleTouchEnd: function(a) { this.initialDistance = NaN;
        ...
        handleReleaseOutside: function() {
            if (d.isModern) {
                ...
                if (!a.preventHover) { a.stopDrag();
                    ...
                    isNaN(c) || isNaN(e) || !(2 < Math.abs(b.x - c) || Math.abs(b.y - e)) || (a.mapWasDragged = !0, b = { type: "dragCompleted", zoomX: a.zoomX(), zoomY: a.zoomY(), zoomLevel: a.zoomLevel(), chart: a }, a.fire(b));
                    (a.mouseIsOver && !a.mapWasDragged && !a.skipClick || a.wasTouched && 4 > Math.abs(a.mouseX - a.tmx) && 4 > Math.abs(a.mouseY - a.tmy)) && a.fire({ type: "click", x: a.mouseX, y: a.mouseY, chart: a });
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) { b.panEventsEnabled && b.mouseIsOver && a && a.preventDefault && a.preventDefault();
        ...
        selectObject: function(a, b) {
            ...
            c.selectedObject = a;
            var f = !1,
                h, k; "MapArea" == a.objectType && (a.autoZoomReal && (f = !0), h = c.areasSettings.selectedOutlineColor, k = c.areasSettings.selectedOutlineThickness);
            ...
            e = a.displayObject;
            f = a.selectedColorReal; "MapImage" == a.objectType && (h = c.imagesSettings.selectedOutlineColor, k = c.imagesSettings.selectedOutlineThickness, e = a.image);
            if (e) {
                if (d.setCN(c, e, "selected-object"), a.bringForwardOnHover && a.displayObject.toFront(), !a.preserveOriginalAttributes) { e.setAttr("stroke", a.outlineColorReal);
                    ...
                    a.selectable || (e.setAttr("cursor", "default"), l && l.setAttr("cursor", "default")) } } else c.returnInitialColorReal(a);
            if (e = a.groupId)
                for (l = a.groupArray, l || (l = c.getGroupById(e), a.groupArray = l), m = 0; m < l.length; m++) {
                    var n = l[m];
                    n.isOver = !1;
                    e = n.displayObject; "MapImage" == n.objectType && (e = n.image);
                    if (e) {
                        var q = n.selectedColorReal;
                        void 0 !== q && e.setAttr("fill", q);
                        void 0 !== h && e.setAttr("stroke", h);
                        void 0 !== k && e.setAttr("stroke-width", k); "MapLine" == n.objectType && ((e = n.lineSvg) && e.setAttr("stroke", f), e = n.arrowSvg) && (e.setAttr("fill", f), e.setAttr("stroke", f)) } }
            c.zoomToSelectedObject();
            g != a && c.fire({ type: "selectedObjectChanged", chart: c }) },
        returnInitialColor: function(a, b) { this.returnInitialColorReal(a);
            b && (a.isFirst = !1);
        ...
        returnInitialColorReal: function(a) { a.isOver = !1;
            ...
            if (b) { b.toPrevious();
                ...
                if (a.showAsSelected) {
                    var c = a.selectedColorReal,
                        k, l; "MapImage" == a.objectType && (k = this.imagesSettings.selectedOutlineColor, l = this.imagesSettings.selectedOutlineThickness); "MapArea" == a.objectType && (k = this.areasSettings.selectedOutlineColor, l = this.areasSettings.selectedOutlineThickness);
                    void 0 !== k && (h = k);
                    void 0 !== l && (f = l) } "bubble" == a.type && (c = void 0);
                void 0 !== c && b.setAttr("fill", c);
                if (k = a.image) k.setAttr("fill", c), k.setAttr("stroke", h), k.setAttr("stroke-width", f), k.setAttr("fill-opacity", e), k.setAttr("stroke-opacity", d); "MapArea" == a.objectType && (c = 1, this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel() * this.mapScale), b.setAttr("stroke", h), b.setAttr("stroke-width", f / c), b.setAttr("fill-opacity", e), b.setAttr("stroke-opacity", d));
        ...
        zoomToLongLat: function(a, b, c, d) { b = this.coordinatesToXY(b, c);
        ...
        buildSVGMap: function() { d.remove(this.mapSet);
            ...
            for (e = 0; e < a.length; e++) {
                ...
                var k = b.path(f);
                k.id = g.id;
                if (this.areasSettings.preserveOriginalAttributes) { k.customAttr = {};
        ...
        setProjection: function(a) { this.projection = a;
            this.chartCreated = !1;
            this.buildEverything() },
        addObjectEventListeners: function(a, b) {
            var c = this;
            a.mousedown(function(a) { c.mouseDownMapObject(b, a) }).mouseup(function(a) { c.clickMapObject(b, a) }).mouseover(function(a) { c.balloonX = NaN;
                c.rollOverMapObject(b, !0, a) }).mouseout(function(a) { c.balloonX = NaN;
                c.rollOutMapObject(b, a) }).touchend(function(a) { 4 > Math.abs(c.mouseX - c.tmx) && 4 > Math.abs(c.mouseY - c.tmy) && (c.tapped = !0);
                c.tapToActivate && !c.tapped || c.mapWasDragged || c.mapWasPinched || (c.balloonX = NaN, c.rollOverMapObject(b, !0, a), c.clickMapObject(b, a)) }).touchstart(function(a) { c.tmx = c.mouseX;
                c.tmy = c.mouseY;
        ...
        checkIfSelected: function(a) {
            ...
            if (b = b.groupId) {
                ...
                for (c = 0; c < b.length; c++)
                    if (b[c] == a) return !0 }
            return !1 },
        clearMap: function() { this.chartDiv.innerHTML = "";
        ...
        showAsRolledOver: function(a) {
            var b = a.displayObject;
            if (!a.showAsSelected && b && !a.isOver) { b.node.onmouseout = function() {};
                ...
                if (void 0 != c)
                    ...
                    if ((e = a.lineSvg) && e.setAttr("stroke", c), e = a.arrowSvg) e.setAttr("fill", c), e.setAttr("stroke", c) } else b.setAttr("fill", c);
                (c = a.imageLabel) && !a.labelInactive && (e = a.labelRollOverColorReal, void 0 != e && c.setAttr("fill", e));
                c = a.rollOverOutlineColorReal;
                void 0 != c && ("MapImage" == a.objectType ? (e = a.image) && e.setAttr("stroke", c) : b.setAttr("stroke", c)); "MapImage" == a.objectType ? (c = this.imagesSettings.rollOverOutlineThickness, (e = a.image) && (isNaN(c) || e.setAttr("stroke-width", c))) : (c = this.areasSettings.rollOverOutlineThickness, isNaN(c) || b.setAttr("stroke-width", c));
                if ("MapArea" == a.objectType) { c = this.areasSettings;
                    ...
                    (c = c.rollOverPattern) && b.pattern(c, this.mapScale, this.path) } "MapImage" == a.objectType && (c = a.rollOverScaleReal, isNaN(c) || 1 == c || (e = b.scale, isNaN(e) && (e = 1), a.tempScale = e, b.translate(b.x, b.y, e * c, !0)));
        ...
        rollOverMapObject: function(a, b, c) {
            if (this.chartCreated) { this.handleMouseMove();
                ...
                if (!this.preventHover) {
                    if (!1 === this.checkIfSelected(a)) {
                        ...
                        this.showAsRolledOver(a) } else(d = a.displayObject) && (this.allowClickOnSelectedObject ? d.setAttr("cursor", "pointer") : d.setAttr("cursor", "default"));
        ...
        stageXToLongitude: function(a) { a = (a - this.mapContainer.x) / this.zoomLevel();
            return this.coordinateToLongitude(a) },
        stageYToLatitude: function(a) { a = (a - this.mapContainer.y) / this.zoomLevel();
            return this.coordinateToLatitude(a) },
        rollOutMapObject: function(a, b) { this.hideBalloon();
        ...
        clickMapObject: function(a, b) {
            ...
            if (c.chartCreated && !c.preventHover && c.checkTouchDuration(b) && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
                ...
                b && b.touches && setTimeout(function() { c.showBalloonAfterZoom.call(c) }, 1E3 *
                    c.zoomDuration);
                c.fire({ type: "clickMapObject", mapObject: a, chart: c, event: b });
                c.objectWasClicked = !0
            }
        },
        showBalloonAfterZoom: function() { this.balloonX = this.longitudeToX(this.clickLongitude);
        ...
        goHome: function() { this.selectObject(this.dataProvider);
        ...
        showDescription: function(a) { a || (a = this.selectedObject);
        ...
        latitudeToCoordinate: function(a) {
            ...
            if (this.mapSet) { b = c.topLatitude;
                var d = c.bottomLatitude; "mercator" == c.projection && (a = this.mercatorLatitudeToCoordinate(a), b = this.mercatorLatitudeToCoordinate(b), d = this.mercatorLatitudeToCoordinate(d));
                b = (a - b) / (d - b) * this.mapHeight }
            return b },
        longitudeToCoordinate: function(a) { a = this.recalcLongitude(a);
            var b, c = this.dataProvider;
            this.mapSet && (b = c.leftLongitude, b = (a - b) / (c.rightLongitude - b) * this.mapWidth);
            return b },
        mercatorLatitudeToCoordinate: function(a) { 89.5 < a && (a = 89.5); - 89.5 > a && (a = -89.5);
        ...
        parseXMLNode: function(a, b, c, d) { void 0 === d && (d = "");
            var g, f, h;
            if (c) {
                var k = c.childNodes.length;
                for (g = 0; g < k; g++) { f = c.childNodes[g];
                    var l = f.nodeName,
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        if (3 == f.nodeType || 4 == f.nodeType) {
                            if ("" !== m) { f = 0;
                                ...
                                f ? a[b]["#text"] = m : a[b] = m } } else if (1 == f.nodeType) {
                        var q;
        ...
        getXY: function(a, b, c) { void 0 !== a && (-1 != String(a).indexOf("%") ? (a = Number(a.split("%").join("")), c && (a = 100 - a), a = Number(a) * b / 100) : c && (a = b - a));
            return a },
        ...
        processObject: function(a, b, c) {
            if (a) {
                ...
                for (e = 0; e < a.length; e++) {
                    var g = a[e];
                    g.parentObject = b; "area" == c && d.extend(g, new d.MapArea(this.theme), !0); "image" == c && (g = d.extend(g, new d.MapImage(this.theme), !0)); "line" == c && (g = d.extend(g, new d.MapLine(this.theme), !0));
                    a[e] = g;
        ...
        trim: function(a) {
            if (a) {
                ...
                for (b = a.length - 1; 0 <= b; b--)
                    if (-1 === " \n\r\t\f\x0B\u00a0\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u200b\u2028\u2029\u3000".indexOf(a.charAt(b))) { a = a.substring(0, b + 1);
                        break }
        ...
        changeProjection: function() { this.minMapXX = Infinity;
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            if (f) {
                ...
                c.set = e;
                c.zoomSet = F;
                5 < p && (f = d.rect(b, g + 6, p + 2 * g + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, 0, 0, 4), d.setCN(a, f, "zoom-bg"), f.translate(-3, -3), f.mouseup(function() { c.handleBgUp() }).touchend(function() { c.handleBgUp() }), F.push(f));
                var E = g;
                B && (E = g / 1.5);
                c.draggerSize = E;
        ...
        draggerDown: function() { this.chart.stopDrag();
            this.isDragging = !0 },
...
(function() {
    ...
    d.SimpleButton = d.Class({
        ...
        setIcon: function(a, b) { this.iconPath = a;
            this.iconSize = b },
        setClickHandler: function(a, b) { this.clickHandler = a;
            this.scope = b },
        setDownHandler: function(a, b) { this.downHandler = a;
            this.scope = b },
        handleUp: function() {
        ...
        handleDown: function() {
            ...
            a && a.call(this.scope) },
        handleOver: function() { this.container.chart.skipClick = !0;
            this.bg.setAttr("fill", this.rollOverColor) },
        handleOut: function() { this.container.chart.skipClick = !1;
...
(function() {
    var d = window.AmCharts;
    d.SmallMap = d.Class({
        construct: function(a) { this.cname = "SmallMap";
        ...
        minimize: function() { this.downButtonSet.hide();
            this.upButtonSet.show();
            this.allSet.hide() },
        maximize: function() { this.downButtonSet.show();
...
(function() {
    ...
    d.AreasProcessor = d.Class({
                ...
                if (b.preserveOriginalAttributes) {
                    if (l.customAttr)
                        for (var q in l.customAttr) l.setAttr(q,
                            l.customAttr[q])
                } else { void 0 != c && l.setAttr("fill", c);
        ...
        createArea: function(a) {
            ...
            if (c && (q = c.area, z = c.title, a.enTitle = c.title, z && !a.title && (a.title = z), (c = b.language) ? (z = d.mapTranslations) && (c = z[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, q)) { a.displayObject = q;
...
(function() {
    var d = window.AmCharts;
    d.ImagesProcessor = d.Class({ construct: function(a) { this.chart = a;
            this.reset() }, process: function(a) {
            var b = a.images,
                c;
            for (c = 0; c < b.length; c++) {
                var d = b[c];
                ...
                d.parentArray = b }
            this.counter = c;
            a.parentObject && a.remainVisible && this.process(a.parentObject) }, createImage: function(a, b) { a = d.processObject(a, d.MapImage);
            ...
            if (F) { isNaN(C) && (C = 10);
                isNaN(E) && (E = 10); "kilometers" == a.widthAndHeightUnits && (C = c.kilometersToPixels(a.width), E = c.kilometersToPixels(a.height)); "miles" == a.widthAndHeightUnits && (C = c.milesToPixels(a.width), E = c.milesToPixels(a.height));
            ...
            G = a.labelColorReal;!a.showAsSelected && c.selectedObject != a || void 0 == h || (D.setAttr("fill", h), G = a.selectedLabelColorReal);
            D = null;
            ...
            return a }, updateSizeAndPosition: function(a) {
            var b = this.chart,
                c = a.displayObject,
                e = b.getX(a.left),
                g = b.getY(a.top),
            ...
            b.makeObjectAccessible(a);
            if (a.line && a.line.getCoordinates) { a.line.chart = b;
            ...
            if (!isNaN(e) && !isNaN(g)) c.translate(e, g, NaN, !0);
                ...
                if (g = b.coordinatesToXY(k, l), e = g.x, g = g.y, isNaN(t) || (e = t), isNaN(r) || (g = r), a.fixedSize) { t = 1;
                    ...
                    c.translate(e, g, t / q + b, !0) } else c.translate(e, g, NaN, !0), n && (this.labelsToReposition.push(a), a.arrays.push({ arr: this.labelsToReposition, el: a }));
            this.positionLabel(n, a, a.labelPositionReal) }, positionLabel: function(a, b, c) {
            if (a) {
                var d = b.image,
                    g = 0,
                    f = 0,
                ...
                var d = a.getBBox(),
                    l = d.width,
                    m = d.height; "right" == c && (g += h + l / 2 + 5, f += k / 2 - 2); "left" == c && (g += -l / 2 - 5, f += k / 2 - 2); "top" == c && (f -= m / 2 + 3, g += h / 2); "bottom" == c && (f += k + m / 2, g += h / 2); "middle" == c && (g += h / 2, f += k / 2);
                a.translate(g + b.labelShiftX, f + b.labelShiftY, NaN, !0);
                b.labelBG && b.labelBG.translate(g - d.width / 2 + b.labelShiftX - 9, f + b.labelShiftY - d.height / 2 - 3, NaN, !0) } }, createPredefinedImage: function(a, b, c, e, g, f) {
            ...
            return k }, reset: function() { this.objectsToResize = [];
            this.allSvgObjects = [];
            this.allObjects = [];
            this.allLabels = [];
...
(function() {
    var d = window.AmCharts;
    d.ImagesSettings = d.Class({ construct: function(a) { this.cname = "ImagesSettings";
            this.balloonText = "[[title]]";
            this.alpha = 1;
            this.borderAlpha = 0;
    ...
    d.LinesProcessor = d.Class({
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < v.length) {
                    ...
                    if (isNaN(p)) {
                        ...
                        p.setAttr("stroke-linecap", "round") } else {
                        x = 1;
                        0 > z && (x = 0);
                        A = { fill: "none", stroke: l, "stroke-opacity": 1, "stroke-width": F / n, "fill-opacity": 0, "stroke-linecap": "round" };
                    ...
                    a.fixedSize && p && (g = { line: p, thickness: F }, this.linesToResize.push(g), a.arrays.push({ arr: this.linesToResize, el: g }), g = { line: l, thickness: 5 }, this.linesToResize.push(g), a.arrays.push({ arr: this.linesToResize, el: g }));
                    a.lineSvg = p;
        ...
        processCoordinates: function(a, b) {
            ...
            for (d = 0; d < a.length; d++) {
                ...
                isNaN(f) || c.push(f) }
            return c },
        reset: function() { this.objectsToResize = [];
            this.allSvgObjects = [];
            this.allObjects = [];
            this.linesToResize = [] }
    })
...
(function() {
    var d = window.AmCharts;
    d.LinesSettings = d.Class({ construct: function(a) { this.cname = "LinesSettings";
            this.balloonText = "[[title]]";
            this.thickness = 1;
            this.dashLength = 0;
            this.arrowSize = 10;
...
(function() {
    var d = window.AmCharts;
    d.MapObject = d.Class({ construct: function(a) { this.fixedSize = this.mouseEnabled = !0;
            this.images = [];
            this.lines = [];
            this.areas = [];
            ...
            this.arrays = [] }, deleteObject: function() { this.remove();
...
(function() {
    var d = window.AmCharts;
    d.MapArea = d.Class({ inherits: d.MapObject, construct: function(a) { this.cname = "MapArea";
            d.MapArea.base.construct.call(this, a);
            d.applyTheme(this, a, this.cname) }, validate: function() { this.chart.areasProcessor.createArea(this) } }) })();
(function() {
    var d = window.AmCharts;
    d.MapLine = d.Class({
        inherits: d.MapObject,
        construct: function(a) { this.cname = "MapLine";
            this.longitudes = [];
            this.latitudes = [];
            this.x = [];
            this.y = [];
        ...
        remove: function() {
            ...
            a && a.remove() },
        getCoordinates: function(a, b) { isNaN(b) && (b = 0);
            if (!isNaN(a)) {
                var c, e, g, f, h, k;
                if (1 < this.longitudes.length) { e = this.chart.coordinatesToXY(this.longitudes[b], this.latitudes[b]);
                    var l = this.chart.coordinatesToXY(this.longitudes[b + 1], this.latitudes[b + 1]);
                    c = e.x;
                    g = l.x;
                    e = e.y;
                    f = l.y } else 1 < this.x.length && (c = this.x[b], g = this.x[b + 1], e = this.y[b], f = this.y[b + 1]);
        ...
        fixToMap: function() {
            if (0 < this.y.length) { this.latitudes = [];
...
(function() {
    var d = window.AmCharts;
    d.MapImage = d.Class({ inherits: d.MapObject, construct: function(a) { this.cname = "MapImage";
            this.scale = 1;
            ...
            d.applyTheme(this, a, this.cname) }, validate: function() { this.chart.imagesProcessor.createImage(this) }, updatePosition: function() { this.chart.imagesProcessor.updateSizeAndPosition(this) }, remove: function() {
            var a = this.displayObject;
            a && a.remove();
            (a = this.imageLabel) && a.remove() }, animateTo: function(a, b, c, d) { isNaN(c) || (this.animationDuration = c);
            ...
            this.animate() }, animateAlong: function(a, b, c) { 1 == this.positionOnLine && this.flipDirection && (this.direction = -1, this.extraAngle = 180);
            ...
            a.frame = 0;
            a.clearTO();
            a.timeOut = setTimeout(function() { a.update.call(a) }, 1E3 / d.updateRate);
            a.fire({ type: "animationStart", chart: a.chart, image: this, lineSegment: a.lineSegment, direction: a.direction }) }, clearTO: function() { this.timeOut && clearTimeout(this.timeOut) }, update: function() {
            var a = this;
            a.updatePosition();
            ...
            var a = this;
            a.clearTO();
            a.animateAlongLine && (a.timeOut = setTimeout(function() { a.animateAlong.call(a) }, 1E3 * a.chart.imagesSettings.pauseDuration)) }, fixToStage: function() {
            ...
            this.validate() }, fixToMap: function() {
            if (!isNaN(this.left)) {
...
(function() {
    ...
    d.processDescriptionWindow = function(a, b) { isNaN(b.descriptionWindowX) && (b.descriptionWindowX = a.descriptionWindowX);
    ...
    d.normalizePath = function(a) {
        for (var b = "", c = d.parsePath(a.getAttribute("d")), e, g, f = Infinity, h = -Infinity, k = Infinity, l = -Infinity, m = 0; m < c.length; m++) {
            var n = c[m],
                q = n.letter,
                t = n.x,
                n = n.y; "h" == q && (q = "L", t += e, n = g); "H" == q && (q = "L", n = g); "v" == q && (q = "L", t = e, n += g); "V" == q && (q = "L", t = e);
    ...
    d.mercator = function(a, b) { b >= Math.PI / 2 - .02 && (b = Math.PI / 2 - .02);
...
(function() {
    var d = window.AmCharts;
    d.MapData = d.Class({ inherits: d.MapObject, construct: function() { this.cname = "MapData";
...
(function() {
    ...
    d.DescriptionWindow = d.Class({
        ...
        close: function() {
            try { this.div.parentNode.removeChild(this.div) } catch (a) {} }
    })
})();
(function() {
    var d = window.AmCharts;
    d.ValueLegend = d.Class({ construct: function(a) { this.cname = "ValueLegend";
            this.enabled = !0;
            ...
            this.color = "#000000";
            this.fontSize = 11;
            d.applyTheme(this, a, this.cname) }, init: function(a, b) {
            if (this.enabled) {
                ...
                isNaN(n) || (e = n);
                isNaN(m) || (e = m - g.width);
                f.translate(e, c) } else d.remove(this.set) } }) })();
(function() {
    var d = window.AmCharts;
    d.ObjectList = d.Class({ construct: function(a) { this.divId = a }, init: function(a) { this.chart = a;
            var b = this.divId;
            ...
            this.addObjects(a.dataProvider, b) }, addObjects: function(a, b) {
            var c = this.chart,
            ...
            0 < d.childNodes.length && b.appendChild(d) }, addObject: function(a, b) {
            var c = this;
