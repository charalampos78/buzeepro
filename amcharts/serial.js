(function() {
    ...
    e.AmRectangularChart = e.Class({
        ...
        construct: function(a) { e.AmRectangularChart.base.construct.call(this, a);
            this.theme = a;
        ...
        initChart: function() { e.AmRectangularChart.base.initChart.call(this);
        ...
        resetMargins: function() {
            ...
            if ("xy" == this.type) {
                ...
                for (b = 0; b < d.length; b++) c = d[b], c.ignoreAxisWidth || (c.setOrientation(!1), c.fixAxisPosition(), a[c.position] = !0) } else { d = this.valueAxes;
        ...
        removeChartCursor: function() { e.callMethod("destroy", [this.chartCursor]);
        ...
        handleMouseDown: function(a) { e.AmRectangularChart.base.handleMouseDown.call(this, a);
...
(function() {
    ...
    e.AmSerialChart = e.Class({
        ...
        drawChart: function() {
            if (0 < this.realWidth && 0 < this.realHeight) { e.AmSerialChart.base.drawChart.call(this);
                var a = this.chartData;
                if (e.ifArray(a)) {
                    var b = this.chartScrollbar;!b || !this.marginsUpdated && this.autoMargins || b.draw();
                    (b = this.valueScrollbar) && b.draw();
                    var a = a.length - 1,
                        c, b = this.categoryAxis;
                    if (b.parseDates && !b.equalSpacing) {
                        if (b = this.startTime, c = this.endTime, isNaN(b) || isNaN(c)) b = this.firstTime, c = this.lastTime } else if (b = this.start, c = this.end, isNaN(b) || isNaN(c)) b = 0, c = a;
        ...
        updateValueAxes: function() { e.AmSerialChart.base.updateValueAxes.call(this);
            var a = this.valueAxes,
                b;
            for (b = 0; b < a.length; b++) {
                var c = a[b],
        ...
        updateMargins: function() { e.AmSerialChart.base.updateMargins.call(this);
            var a = this.chartScrollbar;
        ...
        updateGraphs: function() { e.AmSerialChart.base.updateGraphs.call(this);
            var a = this.graphs,
                b;
            for (b = 0; b < a.length; b++) {
                var c = a[b];
        ...
        updateColumnsDepth: function() {
            if (0 !== this.depth3D || 0 !== this.angle) {
                ...
                if (0 < this.columnsArray.length) { b = this.columnsSet;
        ...
        countColumns: function() {
            var a = 0,
                ...
                d, e, h = !1,
                f, l;
            for (l = 0; l < b; l++) { e = this.valueAxes[l];
                var k = e.stackType;
                if ("100%" == k || "regular" == k)
        ...
        dispatchIndexZoomEvent: function() {
            if (this.drawGraphs && (this.prevStartIndex != this.start || this.prevEndIndex != this.end)) { this.startIndex = this.start;
                this.endIndex = this.end;
                var a = this.chartData;
        ...
        formatPeriodString: function(a, b) {
            if (b) {
                ...
                for (var l = 0; l < c.length; l++) {
                    for (var k = c[l], m = 0, p = 0, n, r, w, z, u, q = 0, D = 0, v, t, x, B, A, G = this.start; G <= this.end; G++) {
                        var y = h[G];
                        if (y && (y = y.axes[g.id].graphs[b.id])) {
                            if (y.values) {
                                var C = y.values[k];
                                if (this.rotate) {
                                    if (0 > y.x || y.x > y.graph.height) C = NaN } else if (0 > y.x || y.x > y.graph.width) C = NaN;
                                if (!isNaN(C)) { isNaN(n) && (n = C);
                                    r = C;
                                    if (isNaN(w) || w > C) w = C;
                                    if (isNaN(z) || z < C) z = C;
                                    u = e.getDecimals(m);
                                    ...
                                    p++;
                                    u = m / p } }
                            if (y.percents && (y = y.percents[k], !isNaN(y))) { isNaN(v) && (v = y);
                                t = y;
                                if (isNaN(x) || x > y) x = y;
                                if (isNaN(B) || B < y) B = y;
                                A = e.getDecimals(q);
                                ...
                                D++;
                                A = q / D } } }
                    q = { open: v, close: t, high: B, low: x, average: A, sum: q, count: D };
                    a = e.formatValue(a, { open: n, close: r, high: z, low: w, average: u, sum: m, count: p }, d, f, k + "\\.", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
        ...
        formatString: function(a, b, c) {
            if (b) {
                ...
                if (void 0 !== a) {
                    ...
                    g || (g = this.nf);
                    h = b.graph.valueAxis;
                    (f = h.duration) && !isNaN(b.values.value) && (f = e.formatDuration(b.values.value, f, "", h.durationUnits, h.maxInterval, g), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), f)); "date" == h.type && (h = e.formatDate(new Date(b.values.value), d.dateFormat, this), f = RegExp("\\[\\[value\\]\\]", "g"), a = a.replace(f, h), h = e.formatDate(new Date(b.values.open), d.dateFormat, this), f = RegExp("\\[\\[open\\]\\]", "g"), a = a.replace(f, h));
                ...
                return a } },
        updateChartCursor: function() { e.AmSerialChart.base.updateChartCursor.call(this);
            var a = this.chartCursor,
                b = this.categoryAxis;
            if (a) {
        ...
        processScrollbars: function() { e.AmSerialChart.base.processScrollbars.call(this);
        ...
        handleCursorMove: function(a) { e.AmSerialChart.base.handleCursorMove.call(this, a);
            var b = a.target,
                c = this.categoryAxis;
                        ...
                        if (b.oneBalloonOnly && b.valueBalloonsEnabled) {
                            ...
                            for (h = 0; h < d.length; h++)
                                if (f = d[h], f.balloon.enabled && f.showBalloon && !f.hidden) { l = f.valueAxis.id;
                                    ...
                                    l = l.y; "top" == f.showBalloonAt && (l = 0); "bottom" == f.showBalloonAt && (l = this.height);
                                    var p = b.mouseX,
                                        n = b.mouseY;
                                    l = this.rotate ? Math.abs(p - l) : Math.abs(n - l);
                                    l < m && (m = l, k = f) }
                            b.mostCloseGraph = k }
                        if (this.prevCursorItem != g || k != this.prevMostCloseGraph) { m = [];
        ...
        handleCursorPanning: function(a) {
            var b = a.target,
                ...
                f = a.delta2Y;
            a = !1;
            if (this.rotate) { isNaN(h) && (h = d, a = !0);
                var l = this.endX0;
                c = this.startX0;
                var k = l - c,
                    l = l - k * h,
...
(function() {
    var e = window.AmCharts;
    e.Cuboid = e.Class({
        construct: function(a, b, c, d, e, h, f, l, k, m, p, n, r, w, z, u, q) { this.set = a.set();
            this.container = a;
            this.h = Math.round(c);
            this.w = Math.round(b);
            this.dx = d;
    ...
    e.CategoryAxis = e.Class({
            ...
            if (e.ifArray(a)) {
                ...
                if (this.parseDates && !this.equalSpacing) this.lastTime = a[a.length - 1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * r), this.minPeriod, 1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw();
                    ...
                    if (this.cellWidth = this.getStepWidth(f), f < l && (l = f), h += this.start, this.stepWidth = this.getStepWidth(f), 0 < l)
                        for (v = Math.floor(f / l), r = this.chooseMinorFrequency(v), f = h, f / 2 == Math.round(f / 2) && f--, 0 > f && (f = 0), l = 0, this.widthField && (f = this.start), this.end - f + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = f; b <= this.end + 2; b++) { p = !1;
                            ...
                            u = 0; "start" == this.gridPosition && (f -= this.cellWidth / 2, u = this.cellWidth / 2);
                            p = !0;
                            a = u; "start" == this.tickPosition && (a = 0, p = !1, u = 0);
                            ...
                            u.serialDataItem = w;
                            this.pushAxisItem(u);
                            this.gridAlpha = z } } else if (this.parseDates && this.equalSpacing) { h = this.start;
                    ...
                    A = f;
                    if (this.data[f].time != e.resetDateToMin(new Date(this.data[f].time), g, w, p).getTime()) { t = 0;
                        var G = n;
                    ...
                    if (0 < this.gridCountR)
                        for (b = f; b < B; b++)
                            if (r = this.data[b].time, this.checkPeriodChange(g, w, r, n) && b >= A) { f = this.getCoordinate(b - this.start);
                                q = !1;
                ...
                for (b = 0; b < x; b++)
                    if (k = this.guides[b], p = v = v = q = d = NaN, m = k.above, k.toCategory && (v = c.getCategoryIndexByValue(k.toCategory), isNaN(v) || (d = this.getCoordinate(v - h), k.expand && (d += this.cellWidth / 2), u = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, k), this.pushAxisItem(u, m))), k.category && (p = c.getCategoryIndexByValue(k.category), isNaN(p) || (q = this.getCoordinate(p - h), k.expand && (q -= this.cellWidth / 2), v = (d - q) / 2, u = new this.axisItemRenderer(this, q, k.label, !0, NaN, v, k), this.pushAxisItem(u, m))), p = c.dataDateFormat, k.toDate && (!p || k.toDate instanceof Date || (k.toDate = k.toDate.toString() + " |"), k.toDate = e.getDate(k.toDate, p), this.equalSpacing ? (v = c.getClosestIndex(this.data, "time", k.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(v) || (d = this.getCoordinate(v - h))) : d = (k.toDate.getTime() - this.startTime) * this.stepWidth, u = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, k), this.pushAxisItem(u, m)), k.date && (!p || k.date instanceof Date || (k.date = k.date.toString() + " |"), k.date = e.getDate(k.date, p), this.equalSpacing ? (p = c.getClosestIndex(this.data, "time", k.date.getTime(), !1, 0, this.data.length - 1), isNaN(p) || (q = this.getCoordinate(p - h))) : q = (k.date.getTime() - this.startTime) * this.stepWidth, v = (d - q) / 2, p = !0, k.toDate &&
                            (p = !1), u = "H" == this.orientation ? new this.axisItemRenderer(this, q, k.label, p, 2 * v, NaN, k) : new this.axisItemRenderer(this, q, k.label, !1, NaN, v, k), this.pushAxisItem(u, m)), 0 < d || 0 < q) { p = !1;
                        if (this.rotate) {
                            if (d < this.height || q < this.height) p = !0 } else if (d < this.width || q < this.width) p = !0;
        ...
        categoryToCoordinate: function(a) {
            if (this.chart) {
                ...
                if (this.parseDates) return this.dateToCoordinate(new Date(a)) } else return NaN },
        coordinateToDate: function(a) {
            return this.equalSpacing ? (a = this.xToIndex(a), new Date(this.data[a].time)) : new Date(this.startTime + a / this.stepWidth) },
        coordinateToValue: function(a) { a = this.xToIndex(a);
        ...
        formatValue: function(a, b) { b || (b = this.currentDateFormat);
            ...
            return a },
        showBalloonAt: function(a) { a = this.parseDates ? this.dateToCoordinate(new Date(a)) : this.categoryToCoordinate(a);
